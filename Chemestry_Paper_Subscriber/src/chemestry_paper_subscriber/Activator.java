package chemestry_paper_subscriber;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		serviceReferenceMathsPapers = context.getServiceReference(ChemestryPaperPublisher.class.getName());
		...
		serviceReferenceChemestryPapers = context.getServiceReference(MathsPaperPublisher.class.getName());
		MathsPaperPublisher mathsPaperPublisher = (MathsPaperPublisher) context.getService(serviceReferenceMathsPapers);
	
		System.out.println("Chemestry Paper has started.");
		System.out.println(" Publishers: ");
		System.out.println("1. English Medium");
		System.out.println("2. Sinhala Medium\n");
		System.out.println("3. Tamil Medium\n");
		
		double total = 0 ;
		double dis = 0 ;
		ArrayList<String> PurchasedItems = new ArrayList<String>();
		int category, year, sel , count = 0 ;
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Chemistry Paper Subscriber has stopped.");
