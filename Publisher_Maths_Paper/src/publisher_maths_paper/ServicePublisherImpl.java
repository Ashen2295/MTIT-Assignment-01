...
public class ServicePublisherImpl implements MathsPaperPublisher {
	...
	@Override
	public void displayMathsPaper(int a) {
		// TODO Auto-generated method stub
		int count ;
		switch (a) {
		case 1:
			count = 1 ;
			for(String name1 : paper_2021.keySet()) {
				String key1 = name1.toString();
				String value1 = paper_2021.get(name1).toString();
		...
		case 3: 
			count = 1 ;
			for(String name3 : paper_2019.keySet()) {
				String key3 = name3.toString();
				String value3 = paper_2019.get(name3).toString();
